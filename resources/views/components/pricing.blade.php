    ...
    <div class="flow-root bg-gray-900 pb-16 pt-24 sm:pt-32 lg:pb-0">
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
            <div class="relative z-10">
                <h2 class="mx-auto max-w-4xl text-center text-5xl font-bold tracking-tight text-white">Simple pricing,
                    no commitment</h2>
                <p class="mx-auto mt-4 max-w-2xl text-center text-lg leading-8 text-white/60">Lorem ipsum dolor sit,
                    amet consectetur adipisicing elit. Velit numquam eligendi quos odit doloribus molestiae voluptatum
                    quos odit doloribus.</p>
                ...
                <div class="mx-auto max-w-2xl space-y-16">
                    <div class="border-t border-gray-900/10">
                        <div class="-mt-px w-72 border-t-2 pt-10 md:w-80 border-transparent">
                            ...
                            <p class="mt-1 text-sm leading-6 text-gray-600">All your essential business finances, taken
                                care of.</p>
                        </div>
                                        ...
                                        <dl class="divide-y divide-gray-200 text-sm leading-6">
                                            <div
                                                ...
                                                <dd class="flex items-center justify-end sm:justify-center sm:px-4">
                                                    <svg class="mx-auto h-5 w-5 text-indigo-600" viewBox="0 0 20 20"
                                                         fill="currentColor" aria-hidden="true">
                                                        <path fill-rule="evenodd"
                                                              d="M16.704 4.153a.75.75 0 01.143 1.052l-8 10.5a.75.75 0 01-1.127.075l-4.5-4.5a.75.75 0 011.06-1.06l3.894 3.893 7.48-9.817a.75.75 0 011.05-.143z"
                                                              clip-rule="evenodd"/>
                                            ...
                                            <div
                                                ...
                                                <dd class="flex items-center justify-end sm:justify-center sm:px-4">
                                                    <svg class="mx-auto h-5 w-5 text-gray-400" viewBox="0 0 20 20"
                                                         fill="currentColor" aria-hidden="true">
                                                        <path
                    ...
                    <div class="border-t border-gray-900/10">
                        <div class="-mt-px w-72 border-t-2 pt-10 md:w-80 border-indigo-600">
                            ...
                            <p class="mt-1 text-sm leading-6 text-gray-600">The best financial services for your
                                thriving business.</p>
                        </div>
                                    ...
                                    <div
                                        ...
                                        <dl class="divide-y divide-gray-200 text-sm leading-6">
                                            ...
                                            <div
                                                ...
                                                <dd class="flex items-center justify-end sm:justify-center sm:px-4">
                                                    <span
                                                        class="font-semibold text-indigo-600">Unlimited accounts</span>
                                                </dd>
                                            </div>
                                            <div
                                                class="flex items-center justify-between px-4 py-3 sm:grid sm:grid-cols-2 sm:px-0">
                                                ...
                                                <dd class="flex items-center justify-end sm:justify-center sm:px-4">
                                                    <span
                                                        class="font-semibold text-indigo-600">Unlimited invoices</span>
                                                </dd>
                                            </div>
                                            <div
                                                class="flex items-center justify-between px-4 py-3 sm:grid sm:grid-cols-2 sm:px-0">
                    ...
                    <div class="border-t border-gray-900/10">
                        <div class="-mt-px w-72 border-t-2 pt-10 md:w-80 border-transparent">
                            ...
                            <p class="mt-1 text-sm leading-6 text-gray-600">Convenient features to take your business to
                                the next level.</p>
                        </div>
