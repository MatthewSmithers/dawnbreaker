            ...
            <div class="mx-auto max-w-7xl px-6 lg:px-8">
                <div
                    ...
                    <img class="col-span-2 max-h-12 w-full object-contain lg:col-span-1"
                         src="images/dupray.svg" alt="Transistor"
                         width="158" height="48">
                    <img class="col-span-2 max-h-12 w-full object-contain lg:col-span-1"
                         src="images/dyson.svg" alt="Reform" width="158"
                         height="48">
                    <img class="col-span-2 max-h-12 w-full object-contain lg:col-span-1"
                         src="images/clorox.svg" alt="Tuple" width="158"
                         height="48">
                    ...
                    <dl class="grid max-w-xl grid-cols-1 gap-x-8 gap-y-10 lg:max-w-none lg:grid-cols-2 lg:gap-y-16">
                        ...
                        <div class="relative pl-16">
                            ...
                            <dd class="mt-2 text-base leading-7 text-gray-600">Quisque est vel vulputate cursus. Risus
                                proin diam nunc commodo. Lobortis auctor congue commodo diam neque.
                            </dd>
                        </div>
                        <div class="relative pl-16">
                            <dt class="text-base font-semibold leading-7 text-gray-900">
        ...
        <div class="mx-auto mt-32 max-w-7xl px-6 lg:px-8">
            <footer aria-labelledby="footer-heading"
                ...
                <div class="xl:grid xl:grid-cols-3 xl:gap-8">
                    <img class="h-32" src="images/dawnbreaker_cleaning_logo.svg"
                         alt="Dawnbreaker">
